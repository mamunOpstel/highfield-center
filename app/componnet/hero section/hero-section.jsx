...
function HeroSection() {
  return (
    <section className=" w-screen bg-cyan-650 ">
      <div
        className=" max-w-[1140px] m-auto text-white p-[80px] pr-[20px] pl-[20px] flex max-md:flex-col items-center justify-center gap-20  "
